...
public class Show_Result_3rd extends javax.swing.JFrame {
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try {
            ...
            rs = st.executeQuery("select * from Student_Information3 inner join Student_Results2 where Student_Information3.Roll_Number='" + roll_num5 + "'and Student_Results2.Roll_Num='" + roll_num5 + "'");
            if (rs.next()) {
